...
//        System.out.println(MemberVoiceID.containsKey(key));
//        System.out.println(MemberVoiceID.get(key).equals(new VoiceRoom(event.getGuild().getId(), event.getChannelLeft().getId())));
//        System.out.println(!MemberVoiceID.get(key).isLocked());
//        System.out.println(channel.getMembers().size() == 0);
    ...
    public void onMessageReceived(@NotNull MessageReceivedEvent event) {
        ...
        if(MessageContent.equals("/del")){
            ...
            if(event.getMember().getVoiceState().getChannel() == null || !event.getMember().getVoiceState().getChannel().getId().equals(MemberVoiceID.get(event.getMember().getUser().getId()).getVoiceChannelID())){
